...
AFRAME.registerComponent('orb-expanding',{
    init: function(){
        ...
        const orb5 = document.querySelector('#orb5');
        const orb6 = document.querySelector('#orb6');
        ...
        this.el.addEventListener('click', function(){
            ...
            setTimeout(function () {
					...
					if (skySrc === '#sky1-2k'){
						currentOrb.setAttribute('src','#sky1-1k');
					} else if (skySrc === '#sky2-2k'){
						currentOrb.setAttribute('src','#sky2-1k');
					} else if (skySrc === '#sky3-2k'){
						currentOrb.setAttribute('src','#sky3-1k');
					} else if (skySrc === '#sky4-2k'){
						currentOrb.setAttribute('src','#sky4-1k');
					} else if (skySrc === '#sky5-2k'){
						currentOrb.setAttribute('src','#sky5-1k');
					} else if (skySrc === '#sky6-2k'){
						currentOrb.setAttribute('src','#sky6-1k');
					} else if (skySrc === '#sky0'){						currentOrb.setAttribute('src','#sky0');
					}
